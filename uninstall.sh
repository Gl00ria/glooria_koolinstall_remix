...
whiptail --title "Gl00ria's DotKool-remix Uninstall Script" --yesno \
  "Hello! This script will uninstall Gl00ria's DotKool-remix for Hyprland packages and configs.
