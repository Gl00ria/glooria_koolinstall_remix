...
## Read [SELF_NOTE](https://github.com/Gl00ria/glooria_koolinstall_remix/blob/glooria_koolinstall_remix/SELF_NOTE.md) before you proceed

<p align="center">
  <img src="https://raw.githubusercontent.com/Gl00ria/glooria_dotkool_remix/glooria_dotkool_remix/assets/latte.png" width="400" />
</p>
...
<p align="center">
  <img src="https://raw.githubusercontent.com/Gl00ria/glooria_dotkool_remix/glooria_dotkool_remix/assets/latte.png" width="200" />
</p>
...
<div align="center">
<br>
  <a href="https://github.com/Gl00ria/glooria_dotkool_remix"><kbd> <br> Glooria's-Dots repo <br> </kbd></a>&ensp;&ensp;
...
- This Repo does not contain Hyprland Dots or configs! Dotfiles can be checked here [`Glooria's-Dots`](https://github.com/Gl00ria/glooria_dotkool_remix) . During installation, if you opt to copy pre-configured dots, it will be downloaded from that centralized repo.
...
```bash
sh <(curl -L https://raw.githubusercontent.com/Gl00ria/glooria_koolinstall_remix/refs/heads/glooria_koolinstall_remix/auto-install.sh)
```
...
```bash
git clone --depth=1 https://github.com/Gl00ria/glooria_koolinstall_remix.git ~/glooria_koolinstall_remix
cd ~/glooria_koolinstall_remix
chmod +x install.sh
./install.sh
```
...
- you can use my prepared script [`LINK`](https://github.com/Gl00ria/glooria_koolinstall_remix/tree/glooria_koolinstall_remix/assets/hyprland-)
- Readme is also there

#### 🙋 👋 Having issues or questions?

- for the install part, kindly open issue on this repo
- for the Pre-configured Hyprland dots / configuration, submit issue [`here`](https://github.com/Gl00ria/glooria_koolinstall_remix/issues)
