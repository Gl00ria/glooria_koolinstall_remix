...
zsh_pkg2=(
  ...
  starship # customizable shell prompt --> config == true
  zoxide   # cd's alternative --> alias = True
  # lsd      # ls's alternative --> alias == True
...
if command -v zsh >/dev/null; then
  ...
  # NOTE: by Gl00ria, both plugins handled in ~/.config/zshrc/03_plugins.sh
...
# NOTE: by Gl00ria, no need with "starship"
